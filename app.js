...
document.getElementsByClassName('bi-chevron-right')[0].addEventListener('click', () => {
    ...
    document.getElementById('calorie').innerHTML = images_dt[(index/310)].calorie;
    document.getElementById('fat').innerHTML = images_dt[(index/310)].fat;
    document.getElementById('protein').innerHTML = images_dt[(index/310)].protein;
